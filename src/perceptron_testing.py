...
# # ------------------------
print "Loading data..."
test_X = np.load('/Users/stephanielaflamme/Desktop/Miniproject-4/numpy_data/test_X.npy')
#test_X = test_X.reshape((len(test_X),200*200))
test_y = np.load('/Users/stephanielaflamme/Desktop/Miniproject-4/numpy_data/test_y.npy')

train_X = np.load('/Users/stephanielaflamme/Desktop/Miniproject-4/numpy_data/train_X.npy')
#train_X = train_X.reshape((len(train_X),200*200))
train_y = np.load('/Users/stephanielaflamme/Desktop/Miniproject-4/numpy_data/train_y.npy')
...
# # ------------------------
classifier = Perceptron(alpha=0.001, n_iter=35)
...
np.save('/Users/stephanielaflamme/Desktop/Miniproject-4/results/perceptron/predictions', predictions)
...
# np.save('/home/ml/slafla2/Miniproject-4/results/perceptron/crossval_results_normalized', cross_val_results)
# np.save('/home/ml/slafla2/Miniproject-4/results/perceptron/crossval_training_accuracy_normalized', cross_val_train_results)
